              ...
              <ul className="list-none p-3 m-0">
                <li>
                  ...
                  <ul className="list-none p-0 m-0 overflow-hidden">
                    <li>
                      <NavLink to={"/dashboard/income"} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
...
mr-2"></i>
                      ...
                      <li>
                          <NavLink to={"/dashboard/admin/esd/doctype"} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
