...
mr-2"></i>
                    ...
                    <li>
                      <Link to={"/dashboard/history"} style={{textDecoration:"none"}} activeStyle  className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
