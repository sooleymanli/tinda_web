...
mr-2"></i>
                    ...
                    <li onClick={()=>navigate("/dashboard/history")} style={{background:"#2196f3",color:"#fff"}}>
                      <a style={{color:"#fff"}}className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
