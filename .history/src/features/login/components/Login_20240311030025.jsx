...
import { useToast } from 'primereact/toast';
...
const Login = () => {
 ...
 try {
    ...
    if(!exception){
    add({ severity: 'success', summary: 'Başarılı', detail: 'Mesajınız başarıyla gösterildi.' });
    dispatch(setUserData(res.data))
    navigate("/dashboard");

    }else{
        add({ severity: 'error', summary: 'Başarılı', detail: 'Mesajınız başarıyla gösterildi.' });
    }
