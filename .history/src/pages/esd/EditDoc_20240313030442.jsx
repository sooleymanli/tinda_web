...
export default function EditDoc() {
  ...
  const fetchData = async (docId) => {
    try {
      ...
      setValue("description",res.data.name)
      setValue("workflows",res.data.name)
      setValue("sendToLeader",res.data.name)
      setValue("sendToUpper",res.data.name)
      setValue("sendToUppviewerser",res.data.name)
    //   setValues({
    //     id: id,
    //     name: name,
