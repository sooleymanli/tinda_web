...
const addUser2 = ()=>{
  ...
  const editTemplate1 = (rowData) => {
    return <Button type="button"  icon="pi pi-file-edit" onClick={()=>navigate(`/dashboard/doc/edit/${rowData.id}`)}  />;
};



const editTemplate2 = (rowData) => {
    return <Button type="button"  icon="pi pi-file-edit" onClick={()=>navigate(`/dashboard/doc/edit/${rowData.id}`)}  />;
};
  return (
    <Wrapper>
      ...
      >
        ...
        <MainDropdownWrapper>
          ...
          rows={5}>
                ...
                <Column style={{ flex: '0 0 4rem' }} body={()=><Button icon="pi pi-times" size="small"  />}></Column>
          ...
          rows={5}>
                <Column field="id" header="id"></Column>
                <Column field="fullName" header="Ad:"></Column>
                <Column style={{ flex: '0 0 4rem' }} body={editTemplate2}></Column>
