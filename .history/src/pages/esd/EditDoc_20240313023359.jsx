...
const addUser2 = ()=>{
    ...
    const removeUser2 = (id)=>{
        setUserTable2([...userTable1.filter((e)=>e.id!==id)  ])
      ...
      >
        ...
        <MainDropdownWrapper>
          ...
          rows={5}>
                ...
                <Column style={{ flex: '0 0 4rem' }} body={()=><Button icon="pi pi-times" size="small"  severity="danger" />}></Column>
          ...
          rows={5}>
                <Column field="id" header="id"></Column>
                <Column field="fullName" header="Ad:"></Column>
                <Column style={{ flex: '0 0 4rem' }} body={(row)=><Button icon="pi pi-times" size="small" severity="danger"  onClick={()=>{console.log(row)}}/>}></Column>
