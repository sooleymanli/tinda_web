...
export default function EditDoc() {
  ...
  const removeUser1 = (e,id) => {
    e.preventDefault()
    setValue("workFlows",[...getValues().workFlows.filter((e) => e.id !== id)]);

  };

  const removeUser2 = (e,id) => {
    e.preventDefault()

    setValue("viewers",[...getValues().viewers.filter((e) => e.id !== id)]);
  };
