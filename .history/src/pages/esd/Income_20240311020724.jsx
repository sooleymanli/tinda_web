...
<DataTable  paginator rows={2} value={products} selectionMode="single" selection={selectedProduct} header={header} onSelectionChange={(e) => setSelectedProduct(e.value)} dataKey="id" metaKeySelection={true} tableStyle={{ width: 'calc(100vW - 304px)',borderRadius:"60px !important" }}>
