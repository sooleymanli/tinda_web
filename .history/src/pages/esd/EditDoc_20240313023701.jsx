...
export default function EditDoc() {
  ...
  const [doctTypeName,setDocTypeName] = useS
      ...
      >
        ...
        <MainDropdownWrapper>
          <DropdownWrapper>
            ...
            <Table>
              <DataTable value={userTable1} emptyMessage="Təsdiqləyənlər əlavə edilməyib"  paginator
          rows={5}>
                <Column field="id" header="id"></Column>
                <Column field="fullName" header="Ad:"></Column>
                <Column style={{ flex: '0 0 4rem' }} body={(row)=><Button icon="pi pi-times"  onClick={()=>{removeUser1(row.id)}} size="small"  severity="danger"  />}></Column>
          ...
          <DropdownWrapper>
            ...
            <Table>
              ...
              <DataTable value={userTable2} emptyMessage="Izləyən əlavə edilməyib"   paginator
          rows={5}>
                <Column field="id" header="id"></Column>
                <Column field="fullName" header="Ad:"></Column>
                <Column style={{ flex: '0 0 4rem' }} body={(row)=><Button icon="pi pi-times" size="small" severity="danger"  onClick={()=>{removeUser2(row.id)}}/>}></Column>
