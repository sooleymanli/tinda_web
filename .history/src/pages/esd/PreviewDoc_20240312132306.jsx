...
<Buttons>
   ...
   {data.showApproveButton && <Button label="Təsdiq et" severity="success" /> }
   {data.showCancelButton && <Button label="Təsdiq et" severity="success" /> }
   {data.showApproveButton && <Button label="Təsdiq et" severity="success" /> }
  <Button label="İmtina et" severity="danger" />
  <Button label="Ləğv et" severity="danger"  />
