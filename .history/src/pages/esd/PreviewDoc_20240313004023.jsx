...
import { setContent, setHeader, setVisible, showModal } from "../../components/modal/modalSlice";
...
dispatch(setHeader("Təsdiqlə"))
dispatch(setContent(<ApproveModalContent />))
        ...
        <Fragment>
          ...
          <Buttons>
            {!data.showApproveButton && (
              <Button label="Təsdiq et" severity="success"   onClick={showApprovemodal}/>
            )}
